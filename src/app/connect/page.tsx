  ...
  return (
    <div className="relative w-full min-h-screen py-24 md:py-32 overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80vw] h-[80vw] max-w-[600px] max-h-[600px] bg-[radial-gradient(circle_at_center,var(--brand-primary)_0%,transparent_60%)] opacity-10 mix-blend-screen blur-[120px]"></div>
      </div>
